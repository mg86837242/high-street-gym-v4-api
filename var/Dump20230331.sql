CREATE DATABASE  IF NOT EXISTS `high_street_gym_v4` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `activities` (
  ...
  `category` enum('Aerobic','Strength','Aerobic & Strength','Flexibility') CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `description` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `intensityLevel` enum('Low','Medium','High','Very High','Varies with Type') CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `maxPeopleAllowed` int DEFAULT NULL,
  `requirementOne` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `requirementTwo` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE `addresses` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lineOne` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `lineTwo` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `suburb` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `postcode` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `addresses` VALUES (1,'1 Amber St','','Brisbane City','4000','QLD','Australia'),(2,'2 Brooklyn St','','Brisbane City','4000','QLD','Australia'),(3,'3 Christine St','','Brisbane City','4000','QLD','Australia'),(4,'4 Diamond St','','Brisbane City','4000','QLD','Australia'),(5,'5 Emblem St','','Brisbane City','4000','QLD','Australia'),(6,'6 Frank St','','Brisbane City','4000','QLD','Australia'),(7,'7 Golden St','','Brisbane City','4000','QLD','Australia'),(8,'8 Helena St','','Brisbane City','4000','QLD','Australia'),(9,'195 Leacroft Road',NULL,'Burbank','4156','QLD','Australia'),(10,'35 The Promenade',NULL,'Benowa','4217','QLD','Australia'),(11,' 46 Victoria Crescent','','Algester','4115','QLD','Australia');
...
INSERT INTO `blogs` VALUES (1,'Title 1','Lorem Ipsum',1,'2023-04-21 21:09:48',NULL),(2,'Title 2','Lorem Ipsum',3,'2023-04-22 21:09:48','2023-03-31 22:36:21'),(3,'Title 3','Lorem Ipsum',5,'2023-04-23 22:36:03','2023-03-31 22:39:40'),(4,'My Blog 1','<img class=\"rounded-3xl mx-auto\" src=\"https://images.unsplash.com/photo-1470093851219-69951fcbb533?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1170&amp;q=80\"><h2>Hi there,</h2><p>This is a <em>basic</em> example of <strong>tiptap</strong>. Sure, there are all kind of basic text styles you’d probably expect from a text editor. But wait until you see the lists:</p><ul><li><p>That’s a bullet list with one …</p></li><li><p>… or two list items.</p></li></ul><p>Isn’t that great? And all of that is editable. But wait, there’s more. Let’s try a code block:</p><pre><code class=\"language-css\">body {\n  display: none;\n}</code></pre><p>I know, I know, this is impressive. It’s only the tip of the iceberg though. Give it a try and click a little bit around. Don’t forget to check the other examples too.</p><blockquote><p>Wow, that’s amazing. Good work, boy!</p></blockquote>',9,'2023-04-30 22:36:03','2023-04-07 10:36:55'),(5,'My Blog 2','<img class=\"rounded-3xl mx-auto\" src=\"https://images.unsplash.com/photo-1470093851219-69951fcbb533?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1170&amp;q=80\"><h2>Hi there,</h2><p>this is a <em>basic</em> example of <strong>tiptap</strong>. Sure, there are all kind of basic text styles you’d probably expect from a text editor. But wait until you see the lists:</p><ul><li><p>That’s a bullet list with one …</p></li><li><p>… or two list items.</p></li></ul><p>Isn’t that great? And all of that is editable. But wait, there’s more. Let’s try a code block:</p><pre><code class=\"language-css\">body {\n  display: none;\n}</code></pre><p>I know, I know, this is impressive. It’s only the tip of the iceberg though. Give it a try and click a little bit around. Don’t forget to check the other examples too.</p><blockquote><p>Wow, that’s amazing. Good work, boy!</p></blockquote>',9,'2023-04-04 12:05:51','2023-04-07 10:42:52');
...
CREATE TABLE `logins` (
  ...
  `role` enum('Member','Trainer','Admin','') CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `accessKey` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `logins` VALUES (1,'jadoe@server.com','password','someadmin','Admin',NULL),(2,'jbdoe@server.com','password','anotheradmin','Admin',NULL),(3,'jcdoe@server.com','password','sometrainer','Trainer',NULL),(4,'jddoe@server.com','password','anothertrainer','Trainer',NULL),(5,'jedoe@server.com','password','somemember','Member',NULL),(6,'jfdoe@server.com','password','anothermember','Member',NULL),(7,'demomember@gmail.com','$2a$06$9RY8fnB/1nc1YFHgLW1OnuujurEO8V8i0ImbpOz0jCDIqR6lwRyoy','demomember','Member',NULL),(8,'demotrainer@gmail.com','$2a$06$VehuPmMl4lSusXp9U.bNruYhWSsx3wfagUxoee0kBgUA1lRyVt0IS','demotrainer','Trainer',NULL),(9,'demoadmin@gmail.com','$2a$06$GKnxDuhrJCyegoiU0eQ.DORpfJ0285vloqXKNDKRfSZRKuyGlNeja','demoadmin','Admin','4a08bd44-7f70-440a-af92-e571218bb8a5');
...
CREATE TABLE `members` (
  ...
  `gender` enum('Female','Male','Other') CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `trainers` (
  ...
  `addressId` int DEFAULT NULL,
  `description` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `specialty` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `certificate` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `imageUrl` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2023-04-07 11:56:13
